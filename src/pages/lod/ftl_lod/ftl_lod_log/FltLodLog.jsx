  ...
  return (
    <div className="container mx-auto p-6 font-poppins">
        ...
        <table className={GlobalStyle.table}>
          <thead className={GlobalStyle.thead}>
            <tr>
              ...
              <th scope="col" className={GlobalStyle.tableHeader}>Created Date</th>
              <th scope="col" className={GlobalStyle.tableHeader}>Failed Reason</th>
              <th scope="col" className={GlobalStyle.tableHeader}>Failed Date</th>
              <th scope="col" className={GlobalStyle.tableHeader}>Handled DRC</th>
            </tr>
          </thead>
          <tbody>
      ...
      <div className="flex justify-end w-full mt-6">
        <Link className={GlobalStyle.buttonPrimary}
        to="/lod/ftl-list">
          Next
        </Link>
      </div>
