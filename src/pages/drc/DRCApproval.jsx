...
const DRCApproval = () => {
  ...
  return (
    <div className={GlobalStyle.fontPoppins}>
      ...
      {/* Filter Section */}
      <div className="flex items-center justify-end gap-4 mt-20 mb-20">
        {/* DRC Select Dropdown */}
        <select
          className={GlobalStyle.selectBox} // Use GlobalStyle for select
          value={selectedDRC}
        ...
        <label className={GlobalStyle.dataPickerDate}>Date </label>
            <DatePicker
              ...
              className="w-40 h-10 p-2 text-sm text-gray-700 bg-white bg-opacity-75 border rounded"
            />
            <DatePicker
              selected={toDate}
      ...
      {/* Table Section */}
      <div className={GlobalStyle.tableContainer}> {/* Use GlobalStyle for table container */}
        <table className={GlobalStyle.table}> {/* Use GlobalStyle for table */}
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-gray-700 bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p>Your approval is in process. You will be redirected shortly.</p>
          </div>
        </div>
      )}
